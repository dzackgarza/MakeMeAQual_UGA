...
\usepackage{cite, hyperref, xcolor}
\usepackage{bm}
...
\settasks{counter-format = (tsk[a]), label-offset = {.7em} }
...
%% New Commands
\newcommand{\inv}{^{-1}}
\newcommand{\X}{\mathscr{X}} % fcnl analysis, vector space X
\newcommand{\C}{\mathbb{C}} % complex numbers
\newcommand{\A}{\mathcal{A}} % sigma-algebra
\newcommand{\B}{\mathcal{B}} % alternate sigma-algebra
\newcommand{\h}{\mathcal{H}} % hilbert series
\newcommand{\T}{\mathscr{T}} % topology
\renewcommand{\S}{\mathscr{S}} % alternate topology
\newcommand{\<}{\langle} % gen set left
\renewcommand{\>}{\rangle} % gen set right
\newcommand{\Z}{\mathbb{Z}} % integers
\newcommand{\N}{\mathbb{N}} % naturals
\newcommand{\R}{\mathbb{R}} % reals
\newcommand{\LL}{\mathcal{L}} % Lebesgue measurable sets
\newcommand{\RR}{\mathcal{R}} % ring?
\newcommand{\D}{\mathbb{D}} % open unit disk
\newcommand{\Q}{\mathbb{Q}} % rationals
\newcommand{\F}{\mathscr{F}} % family of functions
\newcommand{\cl}{\operatorname{cl}}
\newcommand{\ran}{\operatorname{ran}}
\newcommand{\norm}[1]{\| #1 \|} % norm
\newcommand{\inner}[1]{\langle #1 \rangle} %inner product or gen set
\newcommand{\fp}{\mathfrak p} %prime ideal p notation
\newcommand{\fm}{\mathfrak m} %max ideal m notation
\providecommand{\ceil}[1]{\left \lceil #1 \right \rceil}
\providecommand{\floor}[1]{\left \lfloor #1 \right \rfloor}
\renewcommand{\vec}[1]{{\bm #1}}
\newcommand{\eps}{\varepsilon} % comment out if important people want to use this preamble hehe
...
\newcommand{\fourrowvector}[4]{\begin{bmatrix} #1\,\, #2\,\, #3\,\, #4 \end{bmatrix} }
%\newcommand{\threevector}[3]{\begin{bmatrix} #1\\#2\\#3 \end{bmatrix} }

%\newcommand{\comment}[1]{\marginpar{\tiny\color{blue}$\bullet$  #1}}
%\newcommand{\scomment}[1]{\marginpar{\tiny\color{red}$\bullet$  #1}}
...
\draw[line width=0.6mm,-] (0,-1)--(0,-0.5);
\draw[-] (0,-0.5) -- (0,0) -- (0.3536,0.3536) -- (0.3536,0.8536) -- (-0.3536,0.8536) -- (-0.3536,0.3536) -- (0,0) -- cycle;
\draw[-] [line width = 0.25mm,-] (-0.1768,0.3536)--(-0.1768,0.6869);
\draw[-] [line width = 0.25mm,-] (0,0.3536)--(0,0.6869);
\draw[-] [line width = 0.25mm,-] (0.1768,0.3536)--(0.1768,0.6869);
\end{tikzpicture}
}
\newcommand{\rockon}{
...
\renewcommand\qedsymbol{$_{\spatula}$}
%\renewcommand\qedsymbol{$_{\rockon}$}
...
\begin{examproblem}[2016, 4.] Recall that an inner automorphism of a group is an automorphism given by conjugation by an element of the group. An outer automorphism is an automorphism that is not inner.
	\begin{enumerate}[(a)]
...
\end{examproblem}\begin{examproblem}[2014, 7]
